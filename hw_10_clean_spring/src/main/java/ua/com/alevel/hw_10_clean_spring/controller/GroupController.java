package ua.com.alevel.hw_10_clean_spring.controller;
...
import ua.com.alevel.hw_10_clean_spring.controller.dto.CreateGroupRequest;
...
import ua.com.alevel.hw_10_clean_spring.controller.dto.StudentGroupIds;
import ua.com.alevel.hw_10_clean_spring.entity.Group;
import ua.com.alevel.hw_10_clean_spring.entity.Student;
import ua.com.alevel.hw_10_clean_spring.service.GroupService;
import ua.com.alevel.hw_10_clean_spring.service.StudentService;
...
public class GroupController extends BaseController {
    ...
    public String findAll(Model model, PageAndSizeData pageAndSizeData, SortData sortData) {
        ...
        long pageCount = groupService.count() % size == 0 && groupService.count() != 0 ? groupService.count() / size : groupService.count() / size + 1;
